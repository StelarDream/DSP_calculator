...
export async function init() {
  ...
  function enterTreeFromFactory(treeState) {
    ...
    state.treeInitialState = { choices: treeState.choices, overrides: treeState.overrides, proliferation: treeState.proliferation, reuseOverrides: treeState.reuseOverrides, recycleOverrides: treeState.recycleOverrides, manualSupplyOverrides: treeState.manualSupplyOverrides };
  ...
  function restoreSharedTree() {
    ...
    state.view = 'tree';
    state.treeRecipe = recipe;
    state.treeInitialState = { choices: restored.choices, overrides: restored.overrides, proliferation: restored.proliferation, reuseOverrides: restored.reuseOverrides, recycleOverrides: restored.recycleOverrides, manualSupplyOverrides: restored.manualSupplyOverrides };
  }
}
