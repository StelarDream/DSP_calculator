...
// A shipped box - "I'll supply this myself," the manual-supply choice
// card/hub (see treeNode.js's renderManualChoiceNode, the reuse hub's
// manual-supply section, buildTree.js's node.manualSupply). Distinct from
// REUSE_ICON on purpose: this is raw external supply, not leftover drawn
// from elsewhere
// in the tree.
export const SUPPLY_ICON = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 8l-9-5-9 5 9 5 9-5Z"/><path d="M3 8v8l9 5 9-5V8"/><path d="M12 13v8"/></svg>`;
