...
export const PROLIFERATOR_LEVELS = [
  { id: 'mk1', label: 'MK.I', itemId: 'proliferator-mk-i', yield: 1.125, speed: 1.25, amount: 12 },
  { id: 'mk2', label: 'MK.II', itemId: 'proliferator-mk-ii', yield: 1.2, speed: 1.5, amount: 24 },
  { id: 'mk3', label: 'MK.III', itemId: 'proliferator-mk-iii', yield: 1.25, speed: 2, amount: 60 },
];
